...
//!
//! Run: `cargo run -p vital-engine --example render_demo`

use std::io::Write;

use vital_dsp::modulators::EnvelopeParams;
use vital_engine::kernel::{Connection, ModDest, ModSource, SynthVoiceKernel};
use vital_engine::modulation::ModulationTransform;
...
fn make_kernel() -> SynthVoiceKernel {
    ...
    kernel.params.filters[0].params.model = vital_engine::kernel::FilterModel::Digital;
