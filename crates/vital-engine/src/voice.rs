...
pub struct Voice {
    ...
    pub pair: usize,
    /// Slot within the pair (0 or 1) — selects the lane mask.
    pub slot: usize,
    pub state: VoiceNote,
    key_state: KeyState,
...
impl Voice {
    ...
    /// Lanes `[2*slot, 2*slot+1]` — this voice's stereo half of the vector.
    #[inline(always)]
...
impl Trigger {
    ...
    pub fn clear(&mut self) {
        ...
        self.offset = vital_poly::PolyU32::ZERO;
    ...
    pub fn fire(&mut self, mask: PolyMask, value: PolyF32, offset: usize) {
        ...
        self.offset = mask.select_u32(vital_poly::PolyU32::splat(offset as u32), self.offset);
    }
