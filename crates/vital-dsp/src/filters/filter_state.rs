...
use vital_poly::constants::{DB_GAIN_CONVERSION_MULT, MIDI_0_FREQUENCY, PI};
use vital_poly::utils::{catmull_interpolation_matrix, value_matrix};
use vital_poly::{math, PolyF32, PolyU32};
...
// The per-sample paths use the approximations in `vital_poly::math` instead.
// ---------------------------------------------------------------------------
