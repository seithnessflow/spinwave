...
use vital_poly::utils::{cycle_offset_from_seconds, interpolate, stereo_split};
use vital_poly::{PolyF32, PolyMask, PolyU32};
...
pub struct PhaserParams {
    ...
    /// Stereo phase offset in [0, 1] (split ± between L and R).
