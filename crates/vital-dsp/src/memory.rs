...
use vital_poly::matrix::Matrix;
use vital_poly::simd::{PolyF32, PolyMask, PolyU32, LANES};
use vital_poly::utils::catmull_interpolation_matrix;
...
impl Memory {
    ...
    /// Interpolated read `past` samples back (per lane, ≥ [`MIN_PERIOD`]).
    #[inline(always)]
