...
class kissfft
{
    ...
    private:
                ...
                ) const
        {
            ...
            // MSVC has no variable-length arrays. This butterfly only
            // runs for radices other than 2/3/4/5, so it is dead for the
            // power-of-two sizes Vital uses; the heap allocation costs
